"""
Run rule comparison experiments on MNIST data
...
# Dataset params
dataset = 'mnist'
dim = 784  # Dimension of datasets
N = 10000  # Size of datasets

# Feed-forward brain config
m = 10  # Output layer size.
w = 200  # Width of hidden layers.
p = 0.5  # Connectivity probability.
cap = 100  # Number of nodes firing per layer.
...
rules_to_skip = ['PostCount', 'ANNPrePostAll', 'ANNOnePostAll']
